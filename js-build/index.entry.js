...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonInform = __webpack_require__(168);

	//let store = createStore(todoApp)

	var rootElement = document.getElementById('root');

	(0, _reactDom.render)(_react2['default'].createElement(_commonInform.Alert, null), rootElement);
	/*
	render(
...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(Alert, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					"div",
					{ className: "inform-alert-wrap" },
					_react2["default"].createElement(
						"div",
						{ className: "inform-alert" },
						_react2["default"].createElement(
							"div",
							{ className: "inform-alert-header" },
							_react2["default"].createElement(
								"strong",
								{ className: "inform-alert-title" },
								"这里是标题"
							)
						),
						_react2["default"].createElement(
							"div",
							{ className: "inform-alert-body" },
							"这里是文本信息"
						),
						_react2["default"].createElement(
							"div",
							{ className: "inform-alert-footer" },
							_react2["default"].createElement(
								"span",
								null,
								"确定"
					...
					_react2["default"].createElement("div", { className: "inform-mask" })
				);
			}
		}]);
	...
	var Inform = (function (_Component2) {
		_inherits(Inform, _Component2);

		function Inform() {
			_classCallCheck(this, Inform);

			_get(Object.getPrototypeOf(Inform.prototype), "constructor", this).apply(this, arguments);
		}
